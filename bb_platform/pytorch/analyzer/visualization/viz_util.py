...
"""
Source from Captum:
https://github.com/pytorch/captum/blob/e215a5af2629c7e2fb899dbcf417a727fc196f16/captum/attr/_utils/visualization.py
"""
import warnings
...
#         pdb.set_trace()
    ...
    return plt_fig, plt_axis, norm_attr
...
def visualize_image_attr_multiple(
    ...
    **kwargs: Any
    ...
    # Return normalized attribution for each method
    norm_attrs = []
    ...
    for i in range(len(methods)):
        _, _, norm_attr = visualize_image_attr(
            attr,
    ...
    if use_pyplot:
        plt.show()
    return plt_fig, plt_axis, norm_attrs
